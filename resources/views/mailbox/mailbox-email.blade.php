						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li class="nav-active">
										<a href="mailbox-folder.blade.php">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><a href="mailbox-folder.blade.php">Inbox</a></li>
								...
								<div class="nano">
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											<a href="mailbox-compose.blade.php" class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md">
											...
											<ul class="list-unstyled mt-xl pt-md">
												<li>
													<a href="mailbox-folder.blade.php" class="menu-item active">Inbox <span class="label label-primary text-normal pull-right">43</span></a>
												</li>
												<li>
													<a href="mailbox-folder.blade.php" class="menu-item">Important</a>
												</li>
												<li>
													<a href="mailbox-folder.blade.php" class="menu-item">Sent</a>
												</li>
												<li>
													<a href="mailbox-folder.blade.php" class="menu-item">Drafts</a>
												</li>
												<li>
													<a href="mailbox-folder.blade.php" class="menu-item">Trash</a>
												</li>
											</ul>
