...
<html class="fixed">
	<head>
		...
		<title>Vector Maps | Okler Themes | Porto-Admin</title>
							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li class="nav-parent nav-expanded nav-active">
										...
										<ul class="nav nav-children">
											<li>
												<a href="maps-google-maps.blade.php">
													 Basic
												</a>
											</li>
											<li>
												<a href="maps-google-maps-builder.blade.php">
													 Map Builder
												</a>
											</li>
											<li class="nav-active">
												<a href="maps-vector.blade.php">
													 Vector
												</a>
											</li>
										</ul>
