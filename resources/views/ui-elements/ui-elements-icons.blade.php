...
<html class="fixed">
	<head>
		...
		<title>Icons | Okler Themes | Porto-Admin</title>
	...
	<body>
				...
				<section role="main" class="content-body icons-demo-page">
					...
					<section class="panel">
						<header class="panel-heading">
							...
							<h2 class="panel-title">71 New Icons in 4.1</h2>
						</header>
						<div class="panel-body">
			 				<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-automobile"></i> fa-automobile <span class="text-muted">(alias)</span></a></div>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file"></i> fa-file</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-archive-o"></i> fa-file-archive-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-audio-o"></i> fa-file-audio-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-code-o"></i> fa-file-code-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-excel-o"></i> fa-file-excel-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-image-o"></i> fa-file-image-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-movie-o"></i> fa-file-movie-o <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-o"></i> fa-file-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-photo-o"></i> fa-file-photo-o <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-picture-o"></i> fa-file-picture-o <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-sound-o"></i> fa-file-sound-o <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-text"></i> fa-file-text</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-text-o"></i> fa-file-text-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-video-o"></i> fa-file-video-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-word-o"></i> fa-file-word-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-zip-o"></i> fa-file-zip-o <span class="text-muted">(alias)</span></div>
						</div>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-center"></i> fa-align-center</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-justify"></i> fa-align-justify</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-left"></i> fa-align-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-align-right"></i> fa-align-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bold"></i> fa-bold</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chain"></i> fa-chain <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chain-broken"></i> fa-chain-broken</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-clipboard"></i> fa-clipboard</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-columns"></i> fa-columns</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-copy"></i> fa-copy <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-cut"></i> fa-cut <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dedent"></i> fa-dedent <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-eraser"></i> fa-eraser</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file"></i> fa-file</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-o"></i> fa-file-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-text"></i> fa-file-text</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-file-text-o"></i> fa-file-text-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-files-o"></i> fa-files-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-floppy-o"></i> fa-floppy-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-font"></i> fa-font</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-header"></i> fa-header</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-indent"></i> fa-indent</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-italic"></i> fa-italic</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-link"></i> fa-link</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list"></i> fa-list</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list-alt"></i> fa-list-alt</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list-ol"></i> fa-list-ol</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-list-ul"></i> fa-list-ul</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-outdent"></i> fa-outdent</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-paperclip"></i> fa-paperclip</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-paragraph"></i> fa-paragraph</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-paste"></i> fa-paste <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-repeat"></i> fa-repeat</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rotate-left"></i> fa-rotate-left <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-rotate-right"></i> fa-rotate-right <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-save"></i> fa-save <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-scissors"></i> fa-scissors</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-strikethrough"></i> fa-strikethrough</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-subscript"></i> fa-subscript</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-superscript"></i> fa-superscript</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-table"></i> fa-table</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-text-height"></i> fa-text-height</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-text-width"></i> fa-text-width</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-th"></i> fa-th</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-th-large"></i> fa-th-large</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-th-list"></i> fa-th-list</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-underline"></i> fa-underline</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-undo"></i> fa-undo</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-unlink"></i> fa-unlink <span class="text-muted">(alias)</span></div>
						</div>
					</section>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-down"></i> fa-angle-double-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-left"></i> fa-angle-double-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-right"></i> fa-angle-double-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-double-up"></i> fa-angle-double-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-down"></i> fa-angle-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-left"></i> fa-angle-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-right"></i> fa-angle-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-angle-up"></i> fa-angle-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-down"></i> fa-arrow-circle-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-left"></i> fa-arrow-circle-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-down"></i> fa-arrow-circle-o-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-left"></i> fa-arrow-circle-o-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-right"></i> fa-arrow-circle-o-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-o-up"></i> fa-arrow-circle-o-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-right"></i> fa-arrow-circle-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-circle-up"></i> fa-arrow-circle-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-down"></i> fa-arrow-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-left"></i> fa-arrow-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-right"></i> fa-arrow-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrow-up"></i> fa-arrow-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows"></i> fa-arrows</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows-h"></i> fa-arrows-h</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows-v"></i> fa-arrows-v</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-down"></i> fa-caret-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-left"></i> fa-caret-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-right"></i> fa-caret-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-square-o-down"></i> fa-caret-square-o-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-square-o-left"></i> fa-caret-square-o-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-square-o-right"></i> fa-caret-square-o-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-square-o-up"></i> fa-caret-square-o-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-caret-up"></i> fa-caret-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-down"></i> fa-chevron-circle-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-left"></i> fa-chevron-circle-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-right"></i> fa-chevron-circle-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-circle-up"></i> fa-chevron-circle-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-down"></i> fa-chevron-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-left"></i> fa-chevron-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-right"></i> fa-chevron-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-chevron-up"></i> fa-chevron-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-down"></i> fa-hand-o-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-left"></i> fa-hand-o-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-right"></i> fa-hand-o-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hand-o-up"></i> fa-hand-o-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-down"></i> fa-long-arrow-down</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-left"></i> fa-long-arrow-left</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-right"></i> fa-long-arrow-right</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-long-arrow-up"></i> fa-long-arrow-up</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-toggle-down"></i> fa-toggle-down <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-toggle-left"></i> fa-toggle-left <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-toggle-right"></i> fa-toggle-right <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-toggle-up"></i> fa-toggle-up <span class="text-muted">(alias)</span></div>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-backward"></i> fa-backward</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-compress"></i> fa-compress</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-eject"></i> fa-eject</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-expand"></i> fa-expand</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-fast-backward"></i> fa-fast-backward</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-fast-forward"></i> fa-fast-forward</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-forward"></i> fa-forward</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pause"></i> fa-pause</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-play"></i> fa-play</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-play-circle"></i> fa-play-circle</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-play-circle-o"></i> fa-play-circle-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-step-backward"></i> fa-step-backward</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-step-forward"></i> fa-step-forward</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stop"></i> fa-stop</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube-play"></i> fa-youtube-play</div>
						</div>
					</section>
					...
					<section class="panel">
						...
						<div class="panel-body">
							...
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-adn"></i> fa-adn</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-android"></i> fa-android</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-apple"></i> fa-apple</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bitbucket"></i> fa-bitbucket</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bitbucket-square"></i> fa-bitbucket-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-bitcoin"></i> fa-bitcoin <span class="text-muted">(alias)</span></div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-btc"></i> fa-btc</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-css3"></i> fa-css3</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dribbble"></i> fa-dribbble</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-dropbox"></i> fa-dropbox</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-facebook"></i> fa-facebook</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-facebook-square"></i> fa-facebook-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-flickr"></i> fa-flickr</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-foursquare"></i> fa-foursquare</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-github"></i> fa-github</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-github-alt"></i> fa-github-alt</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-github-square"></i> fa-github-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-gittip"></i> fa-gittip</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-google-plus"></i> fa-google-plus</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-google-plus-square"></i> fa-google-plus-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-html5"></i> fa-html5</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-instagram"></i> fa-instagram</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-linkedin"></i> fa-linkedin</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-linkedin-square"></i> fa-linkedin-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-linux"></i> fa-linux</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-maxcdn"></i> fa-maxcdn</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pagelines"></i> fa-pagelines</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pinterest"></i> fa-pinterest</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-pinterest-square"></i> fa-pinterest-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-renren"></i> fa-renren</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-skype"></i> fa-skype</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stack-exchange"></i> fa-stack-exchange</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stack-overflow"></i> fa-stack-overflow</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-trello"></i> fa-trello</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-tumblr"></i> fa-tumblr</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-tumblr-square"></i> fa-tumblr-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-twitter"></i> fa-twitter</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-twitter-square"></i> fa-twitter-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-vimeo-square"></i> fa-vimeo-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-vk"></i> fa-vk</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-weibo"></i> fa-weibo</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-windows"></i> fa-windows</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-xing"></i> fa-xing</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-xing-square"></i> fa-xing-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube"></i> fa-youtube</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube-play"></i> fa-youtube-play</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-youtube-square"></i> fa-youtube-square</div>
						</div>
					</section>
					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-ambulance"></i> fa-ambulance</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-h-square"></i> fa-h-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-hospital-o"></i> fa-hospital-o</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-medkit"></i> fa-medkit</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-plus-square"></i> fa-plus-square</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-stethoscope"></i> fa-stethoscope</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-user-md"></i> fa-user-md</div>
							<div class="fa-hover mb-sm mt-sm col-md-6 col-lg-4 col-xl-3"><i class="fa fa-wheelchair"></i> fa-wheelchair</div>
						</div>
					</section>
					<!-- end: page -->
		...
		<!-- Demo Purpose Only -->
		<style>
			.icons-demo-page .fa-hover {
				cursor: pointer;
				font-size: 15px;
			}

			.icons-demo-page .fa-hover:hover {
				color: #111;
			}

			.icons-demo-page .fa-hover i {
				min-width: 40px;
				padding-right: 15px;
			}

			html.dark .icons-demo-page .fa-hover:hover {
				color: #FEFEFE;
			}
		</style>
	</body>
