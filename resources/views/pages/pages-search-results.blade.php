		...
		<section class="body">
			...
			<header class="header">
				...
				<div class="header-right">
					...
					<form action="pages-search-results.blade.php" class="search nav-form">
					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="pages-user-profile.blade.php"><i class="fa fa-user"></i> My Profile</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="#" data-lock-screen="true"><i class="fa fa-lock"></i> Lock Screen</a>
								</li>
								<li>
									<a role="menuitem" tabindex="-1" href="pages-signin.blade.php"><i class="fa fa-power-off"></i> Logout</a>
								</li>
							</ul>
						</div>
					</div>
								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent nav-expanded nav-active">
										...
										<ul class="nav nav-children">
											<li>
												<a href="pages-signup.blade.php">
													 Sign Up
												</a>
											</li>
											<li>
												<a href="pages-signin.blade.php">
													 Sign In
												</a>
											</li>
											<li>
												<a href="pages-recover-password.blade.php">
													 Recover Password
												</a>
											</li>
											<li>
												<a href="pages-lock-screen.blade.php">
													 Locked Screen
												</a>
											</li>
											<li>
												<a href="pages-user-profile.blade.php">
													 User Profile
												</a>
											</li>
											<li>
												<a href="pages-session-timeout.blade.php">
													 Session Timeout
												</a>
											</li>
											<li>
											...
											<li>
												<a href="pages-timeline.blade.php">
													 Timeline
												</a>
											</li>
											<li>
												<a href="pages-media-gallery.blade.php">
													 Media Gallery
												</a>
											</li>
											<li>
												<a href="pages-invoice.blade.php">
													 Invoice
												</a>
											</li>
											<li>
												<a href="pages-blank.blade.php">
													 Blank Page
												</a>
											</li>
											<li>
												<a href="pages-404.blade.php">
													 404
												</a>
											</li>
											<li>
												<a href="pages-500.blade.php">
													 500
												</a>
											</li>
											<li>
												<a href="pages-log-viewer.blade.php">
													 Log Viewer
												</a>
											</li>
											<li class="nav-active">
												<a href="pages-search-results.blade.php">
													 Search Results
												</a>
											</li>
										</ul>
				...
				<section role="main" class="content-body">
					...
					<div class="search-content">
						<div class="search-control-wrapper">
							<form action="pages-search-results.blade.php">
							...
							<div id="everything" class="tab-pane active">
								...
								<ul class="list-unstyled search-results-list">
									<li>
										...
										<a href="pages-user-profile.blade.php" class="has-thumb">
									...
									<li>
										...
										<a href="pages-invoice.blade.php" class="has-thumb">
											<div class="result-thumb">
									...
									<li>
										...
										<a href="../mailbox/mailbox-email.blade.php" class="has-thumb">
											<div class="result-thumb">
												<i class="fa fa-envelope"></i>
											</div>
											<div class="result-data">
