		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-md-6">
							<form id="form" action="forms-validation.blade.php" class="form-horizontal">
								<section class="panel">
						...
						<!-- col-md-6 -->
						<div class="col-md-6">
							<form id="chk-radios-form" action="forms-validation.blade.php">
								<section class="panel">
									<header class="panel-heading">
										<div class="panel-actions">
											<a href="#" class="fa fa-caret-down"></a>
					...
					<div class="row">
						<div class="col-md-6">
							<form id="summary-form" action="forms-validation.blade.php" class="form-horizontal">
								<section class="panel">
									<header class="panel-heading">
										<div class="panel-actions">
											<a href="#" class="fa fa-caret-down"></a>
						...
						<div class="col-md-6">
							<form id="selects-form" action="forms-validation.blade.php">
								<section class="panel">
									<header class="panel-heading">
										<div class="panel-actions">
											<a href="#" class="fa fa-caret-down"></a>
